    ...
    def modify_exif(self, output_path):
        ...
        try:
            ...
            random_device = random.choice([
                ...
                "Samsung Galaxy S21", "Samsung Galaxy S22", "Samsung Galaxy S23", "Samsung Galaxy S24", "Samsung Galaxy Note 20", "Samsung Galaxy Z Fold 5", "Samsung Galaxy A54",
                "Google Pixel 6", "Google Pixel 6 Pro", "Google Pixel 7", "Google Pixel 7 Pro", "Google Pixel 8", "Google Pixel 8 Pro",
                "Sony Xperia 1 IV", "Sony Xperia 5 IV", "Sony Xperia 10 V", "Sony Xperia Pro-I",
                "Xiaomi 13", "Xiaomi 13 Pro", "Xiaomi 14", "Xiaomi 14 Pro", "Xiaomi Redmi Note 12", "Xiaomi Poco F5",
                "OnePlus 9", "OnePlus 9 Pro", "OnePlus 10 Pro", "OnePlus 11", "OnePlus Nord 3",
                "Huawei P50", "Huawei P60 Pro", "Huawei Mate 50", "Huawei Nova 10",
                "Oppo Find X5", "Oppo Find X6 Pro", "Oppo Reno 9", "Oppo A98",
                "Vivo X90", "Vivo X90 Pro", "Vivo Y78", "Vivo V29",
            ...
            subprocess.run([
                "exiftool-13.31_64/exiftool.exe",
