...
from src.tiktok.locators import Pages, Upload, Ads
from src.tiktok.video import Video
from src.tiktok.auth import Auth
from src.tiktok.utils import delete_video, delete_title
...
class Uploader:
    ...
    def upload_videos(self, videos: [Video]):
        try:
            page: Page = self.auth.authenticate()
    ...
    def __reload_page(self, page: Page):
        ...
        try:
            ...
            page.reload(wait_until='domcontentloaded', timeout=60000)  # 60 seconds timeout
