...
# === SAFE SHIM: VerboseFilters fallback ===
try:
    VerboseFilters  # type: ignore[name-defined]
except Exception:  # NameError if not defined anywhere in the project
    class VerboseFilters:  # minimal fallback to avoid NameError in filters
        # Keep empty to avoid accidentally hiding logs; you can fill with your keywords.
