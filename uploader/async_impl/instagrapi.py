...
try:
	...
	from instagrapi.exceptions import LoginRequired, RateLimitError, ChallengeError, ClipConfigureError, ClipNotUpload  # type: ignore
except Exception:
	...
	ClipNotUpload = Exception  # type: ignore
